     <!-- Modal -->
     <div class="modal fade" id="createModal" aria-hidden="false" tabindex="-1" aria-labelledby="createModalLabel"
         data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog">
             <div class="modal-content">
                 <form method="post" @submit.prevent="onCreateSubmit">
                     <div class="modal-header">
                         <h5 class="modal-title" id="createModalLabel">เพิ่มข้อมูล</h5>
